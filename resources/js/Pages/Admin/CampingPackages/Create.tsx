...
export default function Create({ mountains = [], products = [] }: CreateProps) {
  ...
  const handleSaveDraft = () => {
    toast.success("Draf paket camping berhasil disimpan sementara!");
  };

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    post('/admin/camping-packages', {
      onSuccess: () => {
        toast.success("Paket camping baru berhasil ditambahkan!");
      },
      onError: () => {
        toast.error("Gagal menambahkan paket camping. Silakan periksa kembali form Anda.");
      }
    });
  };

  return (
    <AdminLayout title="Tambah Paket Camping">
      <div className="pb-16 sm:pb-0">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            <h1 className="text-xl sm:text-2xl font-semibold tracking-tight text-foreground">Tambah Paket Camping Baru</h1>
            <p className="text-xs sm:text-sm text-muted-foreground mt-1">
              Buat paket bundling perlengkapan camping dan trip siap pakai.
            </p>
          </div>
        ...
        <form id="create-package-form" onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <CardContent className="space-y-6">
                ...
                <Field>
                  ...
                  <Input 
                    ...
                    placeholder="Contoh: Paket Camping All-In Prau 4 Person" 
                    required 
                  />
                ...
                <Field>
                  ...
                  <Textarea 
                    ...
                    placeholder="Deskripsikan apa saja keunggulan dan rincian paket ini..." 
                    required 
                  />
              ...
              <CardContent className="space-y-4">
                ...
                <Field>
                  ...
                  <Input 
                    ...
                    placeholder="Best Seller, Hemat, Rekomendasi..." 
                  />
                </Field>
                ...
                <Field>
                  ...
                  <Input 
                    ...
                    placeholder="camping, all-in, prau, dieng..." 
                  />
                </Field>
              </CardContent>
            </Card>
